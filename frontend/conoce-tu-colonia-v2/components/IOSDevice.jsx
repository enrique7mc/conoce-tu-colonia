...
// iOS 26 (Liquid Glass) device frame. No assets, no deps.
// Only IOSDevice is used by the app; the other helpers stay in case the
// design evolves to need a nav bar, list, or keyboard.
